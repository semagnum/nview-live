...
properties = [
    ...
    ('nl_budget_option', bpy.props.EnumProperty(name='Budget Type',
                                                ...
                                                items=[('none', 'None', 'Just do distance culling, no budgeting'),
                                                       ('objects', 'Objects', 'Limit number of visible objects'),
                                                       ('verts', 'Vertices', 'Limit visible objects by vertex count (meshes only)'),
                                                       ('tris', 'Triangles', 'Limit visible objects by triangle count (meshes only)'),
                                                       ],
                                                default='verts')),
